...
const lessonData: LessonSection[] = [
  {
    id: "I",
    title:
      "Đường lối chiến tranh nhân dân của Đảng – bài học chiến lược bao trùm toàn bộ hai cuộc kháng chiến",
    content: [
      {
  ...
  },
  {
    id: "II",
    title:
      "Sự lãnh đạo đúng đắn, sáng suốt và nhất quán của Đảng – nhân tố quyết định mọi thắng lợi",
    content: [
      {
  ...
  },
  {
    id: "III",
    title:
      "Bài học về xây dựng lực lượng – từ du kích nhỏ lẻ đến quân đội chính quy, từng bước hiện đại",
    content: [
      {
        body: [
  ...
  },
  {
    id: "IV",
    title:
      "Bài học về lòng yêu nước, ý chí sắt đá và tinh thần hy sinh không bờ bến",
    content: [
  ...
  },
  {
    id: "VI",
    title:
      "Bài học về công tác dân vận, xây dựng niềm tin với Nhân dân",
    content: [
      {
        body: [
  ...
  },
  {
    id: "VII",
    title:
      "Bài học về khát vọng độc lập – tự cường, khát vọng vươn tới tương lai",
    content: [
      {
    ...
    return (
      <div className="mt-4 p-4 md:p-6 rounded-xl border-l-4 border-yellow-500 bg-yellow-50 shadow-inner">
        <h4 className="text-lg font-bold text-yellow-700 mb-2 flex items-center">
          ...
          {content.title || "Liên hệ giới trẻ"}
        </h4>
...
const LessonSectionCard: React.FC<{ section: LessonSection }> = ({
  section,
}) => {
  return (
    <div className="bg-white p-6 md:p-8 rounded-xl shadow-2xl mb-8 border-t-8 border-red-700/70 transition-shadow hover:shadow-3xl">
      <h2 className="text-2xl font-extrabold text-gray-900 mb-4 flex items-start">
        <span className="text-3xl font-black mr-3 text-red-700/90">
          {section.id}
        </span>
        {section.title}
      </h2>
...
const App: React.FC = () => {
  return (
    ...
    >
      {/* Header / Title Section – cố định kiểu giống file Quiz (không ẩn/hiện theo scroll) */}
      <header
        className="py-16 text-white shadow-2xl"
        style={{
          backgroundImage:
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto backdrop-blur-sm bg-white/90 p-8 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          {/* Tiêu đề chính */}
          <h2 className="text-center text-3xl font-black text-red-800 mb-10 border-b-2 border-red-700/50 pb-4">
          ...
          <div className="mt-12 p-6 text-center bg-gray-900 rounded-xl text-white shadow-2xl">
            <p className="text-lg font-light">
              ...
              Toàn bộ bài học này là tài sản vô giá của dân tộc, cần được thế hệ
              trẻ tiếp thu và phát huy trong thời đại mới.
            </p>
          </div>
        </div>
      </main>
