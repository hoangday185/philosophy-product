...
<div>
	<next-image
		src="/kccp/kccp_1_nam_bo_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Nhân dân Nam bộ nổi dậy kháng chiến chống Pháp. Ảnh tư liệu ."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_1_nam_bo_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Chợ Bến Thành trong ngày đầu kháng chiến chống thực dân Pháp xâm lược, ngày 23/9/1945."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_1_nam_bo_4.jpg"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Lực lượng vũ trang cách mạng tham gia phong trào Nam tiến, sát cánh cùng đồng bào Nam bộ và Nam Trung bộ đánh giặc cứu nước. Ảnh: Tư liệu TTXVN."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>	
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_2_ha_noi_1.jpg"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Phần lớn người dân Hà Nội đã được tản cư, chướng ngại vật được dựng lên ở khắp nơi. Thủ đô sẵn sàng chiến đấu chống lại quân xâm lược Pháp. (Ảnh: Tư liệu TTXVN)."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_2_ha_noi_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội đào giao thông hào ở Bắc Bộ Phủ, sẵn sàng quyết chiến với giặc Pháp. (Ảnh: Tư liệu TTXVN)."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_2_ha_noi_3.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Chiến sĩ quyết tử Trần Thành (Nguyễn Văn Thiềng) ôm bom ba càng đón đánh xe tăng Pháp năm 1946."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>	
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_3_hai_phong_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Tàu chiến Pháp tấn công Hải Phòng ngày 20/11/1946."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_3_hai_phong_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Tàu chiến của Pháp nã đại bác vào Hải Phòng, tháng 11, 1946."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_3_hai_phong_3.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Bộ đội đào giao thông hào ở Bắc Bộ Phủ, sẵn sàng quyết chiến với giặc Pháp. (Ảnh: Tư liệu TTXVN)."
...
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_4_thua_thien_hue_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="2 giờ 30 phút ngày 20-12-1946, khẩu sơn pháo 75 ly nhả đạn, báo hiệu cho cuộc tấn công, bao vây quân Pháp tại Huế. Nguồn: tapchisonghuong.com.vn ."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_4_thua_thien_hue_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Mặt trận Thủ đô năm 1946-1947. Quang cảnh phố Huế nơi ngã ba phố Huế. "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_4_thua_thien_hue_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Chỉ thị của Chính phủ về cuộc kháng chiến chống thực dân Pháp, ngày 20-12-1946."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_4_thua_thien_hue_4.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Quyết tử quân thề kiên quyết sống chết giữ vững Thủ đô, 12-1946."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>	
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_5_viet_bac_thu_dong_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội pháo binh làm nên chiến thắng sông Lô trong chiến dịch Việt Bắc-Thu Đông 1947. (Ảnh: Tư liệu/TTXVN phát) Nguồn: tapchisonghuong.com.vn ."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_5_viet_bac_thu_dong_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Xác chiếc tàu L.C.T của quân đội Pháp bị pháo binh ta bắn đắm trên sông Lô Việt trong chiến dịch Việt Bắc - Thu Đông năm 1947. "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_5_viet_bac_thu_dong_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Nhân dân Phú Thọ cắm chông chống quân Pháp nhảy dù trong chiến dịch Việt Bắc - Thu Đông 1947. Ảnh: Tư liệu/TTXVN phát."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_5_viet_bac_thu_dong_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bảo vệ Bác Hồ trên đường đi kháng chiến tại Điềm Mặc, Định Hóa, Thái Nguyên mùa hè năm 1947. Ảnh: Tư liệu/TTXVN phát."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_5_viet_bac_thu_dong_5.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Cán bộ Mặt trận sông Lô nghiên cứu kế hoạch đánh địch tiến công lên Việt Bắc - Thu Đông 1947."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_5_viet_bac_thu_dong_6.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Tàu chiến của Pháp bị quân ta đánh đắm trên sông Lô trong chiến dịch Việt Bắc - Thu Đông 1947."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>	
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_6_la_nga_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Làm chủ trận địa La Ngà trong trận tập kích ngày 1-3-1948."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_6_la_nga_2.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Tượng đài chiến thắng La Ngà."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>	
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_7_moc_hoa_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bắt sống đồn trưởng Louis Bertrand trong trận Mộc Hóa năm 1948."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_7_moc_hoa_2.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Chiến lợi phẩm thu được trong trận Mộc Hóa (ảnh tư liệu từ Bảo tàng – Thư viện tỉnh"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_8_bien_gioi_thu_dong_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Tháng 6/1950, Chủ tịch Hồ Chí Minh cùng Thường vụ Trung ương Đảng chủ trương mở chiến dịch lớn đánh địch trên tuyến biên giới Việt-Trung. Nguồn: TTXVN."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_8_bien_gioi_thu_dong_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Đại tướng Võ Nguyên Giáp và Chủ tịch Hồ Chí Minh bàn kế hoạch tác chiến với các sĩ quan quân đội trong chiến dịch vào hạ tuần tháng 8/1950. Nguồn: TTXVN."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_8_bien_gioi_thu_dong_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Số lượng lớn pháp binh và công binh của Bộ Tư lệnh được tập trung cho Chiến dịch biên giới. Nguồn: TTXVN."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_8_bien_gioi_thu_dong_4.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Trải qua 29 ngày chiến đấu quyết liệt, quân và dân ta đã giành được thắng lợi to lớn trong Chiến dịch Biên giới, bộ đội ta tiến vào giải phóng Thất Kê năm 1950. Nguồn: TTXVN."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_9_hoa_binh_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Lực lượng dân công vận chuyển vũ khí, lương thực cho chiến dịch Hòa Bình năm 1951-1952."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_9_hoa_binh_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội pháo binh ta đón đánh địch trên sông Đà trong trận Tu Vũ, mở màn Chiến dịch Hòa Bình."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_9_hoa_binh_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Tướng Đờ Lát đơ Tátxinhi (1889-1952), Tổng chỉ huy quân đội, kiêm Cao ủy Pháp ở Đông Dương năm 1950-1952 ."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_9_hoa_binh_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Xe tăng và trận địa hỏa lực của Pháp bị bộ đội ta tiêu diệt trong Chiến dịch Hòa Bình. Ảnh tư liệu "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_9_hoa_binh_5.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Núi Chẹ, một trong các cứ điểm trong phòng tuyến sông Đà của Pháp bị bộ đội ta tiêu diệt trong chiến dịch Hòa Bình."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_10_tay_bac_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Đại tướng Võ Nguyên Giáp và các cộng sự nghiên cứu sa bàn chuẩn bị đánh đồn nghĩa Lộ trong chiến dịch Tây Bắc năm 1952. "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_10_tay_bac_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội ta hành quân trong chiến dịch Tây Bắc, năm 1952 (Ảnh tư liệu BTLSQG)."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_10_tay_bac_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Đồn Sơn Bục ở Nghĩa Lộ (Yên Bái) bị quân ta tiêu diệt trong chiến dịch Tây Bắc, năm 1952."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_10_tay_bac_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip=""
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_10_tay_bac_5.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip=""
	...
	/>
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_11_thuong_lao_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội chuẩn bị bộc phá cho trận đánh trong chiến dịch Thượng Lào, năm 1953."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_11_thuong_lao_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Lễ kết nghĩa bộ đội Việt Nam và bộ đội Pa-thét Lào trong Chiến dịch Thượng Lào năm 1953."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_11_thuong_lao_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Hoàng thân Xuvanuvông và Đại tướng Võ Nguyên Giáp bàn kế hoạch phối hợp mở chiến dịch Thượng Lào, năm 1953."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_11_thuong_lao_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Lược đồ các mũi tiến công của ta trong chiến dịch Thượng Lào, tháng 5-1953."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_11_thuong_lao_5.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Liên quân Việt-Lào tiến vào giải phóng Sầm Nưa, tỉnh Hủa Phăn, 4/1953."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_12_dien_bien_phu_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Đại tướng Võ Nguyên Giáp và Bộ Tổng tham mưu Quân đội Nhân dân Việt Nam trong chiến dịch Điện Biên Phủ. "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_12_dien_bien_phu_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Tướng De Castries và quân Pháp bị bắt tại Điện Biên Phủ."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_12_dien_bien_phu_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội ta xung phong đánh chiếm lô cốt cuối cùng của địch ở cứ điểm C1. Ảnh: TTXVN."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_12_dien_bien_phu_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Lược đồ về diễn biến trận đánh cứ điểm C1."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_12_dien_bien_phu_5.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Đại tướng Võ Nguyên Giáp trao lá cờ Quyết chiến quyết thắng - giải thưởng luân lưu của Hồ Chủ tịch cho Tướng Đàm Quang Trung, Đại đoàn phó 312 trước giờ tấn công Đồn Him Lam, Điện Biên Phủ."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_12_dien_bien_phu_6.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Chiều 7/5/1954, lá cờ "Quyết chiến - Quyết thắng" của Quân đội nhân dân Việt Nam tung bay trên nóc hầm tướng De Castries, đánh dấu thời khắc của chiến thắng Điện Biên Phủ. Ảnh tư liệu."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccp/kccp_13_dak_po_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Sơ đồ trận Đắk Pơ"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_13_dak_po_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Binh đoàn 100 Mobile Group Pháp trong trận Đắk Pơ – trận cây số 15 đèo Mang Yang – Mang Yang Pass Ambush 1954"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccp/kccp_13_dak_po_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Lính Pháp đầu hàng trên Đường 19 (An Khê-Đak Pơ), tháng 6/1954. Ảnh tư liệu"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccp/kccp_13_dak_po_5.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Bia tưởng niệm cán bộ chiến sỹ hy sinh trong trận tiêu diệt binh đoàn cơ động (GM) 100 của Pháp."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
    ...
    address: [
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_1_ben_tre_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Đội quân tóc dài” Bến Tre đấu tranh trực diện với kẻ thù trong cuộc Đồng khởi 1960. Ảnh: Tư liệu BT"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		...
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Phó tư lệnh các Lực lượng vũ trang giải phóng miền Nam Việt Nam Nguyễn Thị Định thăm một đơn vị nữ du kích năm 1961. Ảnh: baotanglichsu.vn"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_1_ben_tre_4.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Các mẹ, các chị “tản cư ngược” về thị trấn Mỏ Cày chống chiến dịch khủng bố sau Đồng Khởi của địch. Ảnh: Tư liệu."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_2_tien_giang_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Chiến thuật “trực thăng vận” của Mỹ."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_2_tien_giang_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Máy bay và trận địa của địch bị Quân giải phóng tiêu diệt trong Chiến thắng Ấp Bắc (1/1963). Ảnh: Tư liệu TTXVN"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_2_tien_giang_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Khẩu đội súng máy 12,7mm đã bắn rơi các máy bay lên thẳng của Mỹ trong trận Ấp Bắc. Ảnh: Tư liệu/TTXVN phát"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_2_tien_giang_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Các chiến sĩ Tiểu đoàn Mỹ Tho đánh thắng trận Ấp Bắc được mang tên Tiểu đoàn Ấp Bắc. Ảnh: Tư liệu/TTXVN phát"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_2_tien_giang_5.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip=""
	...
	/>
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_3_ba_ria_vung_tau_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Sơ đồ chiến dịch Bình Giã"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_3_ba_ria_vung_tau_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Máy bay của địch bị bắn rơi trong Chiến dịch Bình Giã. Ảnh tư liệu của Bảo tàng Bà Rịa-Vũng Tàu. "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_3_ba_ria_vung_tau_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Tặng thưởng cờ Quyết chiến quyết thắng cho đơn vị chiến thắng Bình Giã"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_3_ba_ria_vung_tau_4.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Lính Mỹ bị thương tháo chạy tại chiến trường Bình Giã"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_4_quang_ngai_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Sơ đồ chiến dịch Ba Gia"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_4_quang_ngai_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Quân đội Sài Gòn bị thiệt hại trong chiến dịch Ba Gia."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_4_quang_ngai_3.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Tượng đài chiến thắng Ba Gia"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
...
<div>
	<next-image
		src="/kccm/kccm_5_binh_phuoc_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Sơ đồ chiến dịch Đồng Xoài"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_5_binh_phuoc_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip=""
...
<div>
	<next-image
		src="/kccm/kccm_5_binh_phuoc_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip=""
...
<div>
	<next-image
		src="/kccm/kccm_5_binh_phuoc_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Trận đồng xoài 1965"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_5_binh_phuoc_5.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Du kích việt cộng đang chiến đấu trong trân đồng xoài."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_5_binh_phuoc_6.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Phước Long"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_5_binh_phuoc_7.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Truy kích địch trong thị xã Phước Long, ngày 5-1-1975. Ảnh tư liệu "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
`,
...
<div>
	<next-image
		src="/kccm/kccm_6_quang_tri_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Sơ đồ chiến dịch Đường 9 – Khe Sanh"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_6_quang_tri_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ tổng tham mưu phổ biến kế hoạch chiến dịch Đường 9 - Khe Sanh cho cán bộ chủ chốt trong cơ quan"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_6_quang_tri_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội ta tấn công vào Quảng Trị (ảnh tư liệu) năm 1972. Ảnh tư liệu Bảo tàng Lịch sử Quốc gia. "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_6_quang_tri_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội ta ngăn chặn địch vào Thành cổ Quảng Trị (ảnh tư liệu Bảo tàng Lịch sử Quốc gia)."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_6_quang_tri_5.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Phút nghỉ ngơi sau trận đánh của phóng viên Đoàn Công Tính cùng các chiến sĩ Trung đoàn 48 và K8 tại Thành cổ Quảng Trị, năm 1972. (Ảnh tư liệu: Đoàn Công Tính)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
`,
...
<div>
	<next-image
		src="/kccm/kccm_7_thua_thien_hue_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Sơ đồ chiến dịch Đường 9 – Khe Sanh"
...
<div>
	<next-image
		src="/kccm/kccm_7_thua_thien_hue_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Chiến sĩ giải phóng quân Trị Thiên, Huế nghiên cứu sa bàn chuẩn bị đánh tiểu đoàn 7 thiết giáp Nguỵ ở Tam Thai, Huế ngày 31-1-1968. Ảnh: tư liệu TTXVN"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_7_thua_thien_hue_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Chiến sự trên đường phố ở Huế."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_7_thua_thien_hue_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Các lực lượng vũ trang giải phóng tiến vào cửa Ngọ Môn (Huế) sáng 26/3/1975. Ảnh: TTXVN"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_7_thua_thien_hue_5.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Quân Giải phóng Trị Thiên Huế tiếp quản Thừa Thiên Huế trong chiến dịch Huế - Đà Nẵng"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_7_thua_thien_hue_6.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Xe tăng Quân giải phóng tiến vào thành phố Đà Nẵng. Ảnh: Tư Liệu"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_8_quang_nam_da_nang_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ binh và xe tăng quân Giải phóng tiến vào giải phóng Đà Nẵng (29/3/1975). (Ảnh: Hoàng Giang/TTXVN)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_8_quang_nam_da_nang_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Đến 15 giờ ngày 29/3/1975, quân ta chiếm lĩnh toàn bộ căn cứ liên hợp Đà Nẵng, bán đảo Sơn Trà và tới 17 giờ giải phóng hoàn toàn thành phố Đà Nẵng. Trong ảnh: Quân Giải phóng hành quân qua cầu Nguyễn Tri Phương tiến vào Đà Nẵng"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_8_quang_nam_da_nang_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Quân Giải phóng tiến vào thành phố Đà Nẵng trong sự chào đón hân hoan của các tầng lớp nhân dân."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_8_quang_nam_da_nang_4.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Chỉ trong một thời gian ngắn, ta đã tiêu diệt được nhiều sư đoàn chủ lực của địch, giành thắng lợi toàn chiến dịch. Trong ảnh: Quân Giải phóng làm chủ các cơ quan ngụy quyền trong thành phố Đà Nẵng."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_9_ha_noi_hai_phong_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip=""
...
<div>
	<next-image
		src="/kccm/kccm_9_ha_noi_hai_phong_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội Tên lửa quán triệt nhiệm vụ trong Chiến dịch Phòng không Hà Nội-Hải Phòng, năm 1972. Ảnh tư liệu"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_9_ha_noi_hai_phong_3.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Xác máy bay Mỹ bị bắn rơi ở ngoại thành Hà Nội, tháng 12-1972_Ảnh: TTXVN"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_10_dak_lak_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bộ đội vận tải thuộc đơn vị 250 (Gia Lai) chuyển lương thực, vũ khí ra chiến trường. (Ảnh: Anh Tôn-TTXVN)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_10_dak_lak_2.jpg"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Các chiến sĩ đoàn Pleime (Gia Lai) thảo luận phương án đánh địch. (Ảnh: Phú Tuấn-TTXVN)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_10_dak_lak_3.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Xe tăng và bộ đội chủ lực đánh chiếm Sư bộ 23 "
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_11_dong_nai_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Mặt trận Xuân Lộc"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_11_dong_nai_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Quân giải phóng phát triển tiến công đánh chiếm Sở chỉ huy sư đoàn 18 ngụy trong Chiến dịch Xuân Lộc tháng 4/1975."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_11_dong_nai_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Chỉ huy Trung đoàn 3 (Sư đoàn 304) bàn phương án tác chiến trong Chiến dịch Xuân Lộc. (ảnh tư liệu)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_11_dong_nai_3.jpg"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Quân giải phóng làm chủ, áp giải tù binh tại Tiểu khu Long Khánh ngày 21-4-1975."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_11_dong_nai_4.png"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Đập tan cánh cửa thép Xuân Lộc, mở đường tiến vào Sài Gòn."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
      ...
      },
      {
		...
		<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_1.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Cuối tháng 3/1975, đồng chí Lê Đức Thọ từ miền Bắc vào Nam cùng đồng chí Phạm Hùng và Đại tướng Văn Tiến Dũng thay mặt Bộ Chính trị trực tiếp chỉ đạo Chiến dịch giải phóng Sài Gòn (Ảnh: TTXVN)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_2.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Xe tăng của Quân Giải phóng tiến vào dinh Độc Lập trưa 30/4/1975.  (Ảnh: TTXVN)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_3.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Quân giải phóng đánh Sân bay Tân Sơn Nhất ngày 30/4/1975. (Ảnh: Đinh Quang Thành)"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_4.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Lữ đoàn tăng 203 cùng Sư đoàn bộ binh 304, Quân đoàn 2 đánh địch trên xa lộ Biên Hòa-Sài Gòn, tiến vào giải phóng thành phố Sài Gòn (Ảnh: Đinh Quang Thành)."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_5.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Bức ảnh chụp chiếc xe tăng 390 - chiếc xe đầu tiên húc đổ cánh cổng Dinh Độc Lập trưa ngày 30.4.1975 của nữ nhà báo Pháp Francoise de Mulder"
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_6.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Toàn cảnh đội hình xe tăng Lữ đoàn 203 tiến vào Dinh Độc Lập trưa ngày 30/4/1975 (Ảnh: Borries Gallasch)."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_7.png"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Nụ cười hạnh phúc của người chiến sĩ trong ngày giải phóng hoàn toàn miền Nam, thống nhất đất nước."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div>
	<next-image
		src="/kccm/kccm_12_sai_gon_8.jpg"
		width="400"
		height="250"
		alt="Lực lượng Nam Bộ kháng chiến"
		data-tooltip="Những người lính đi chợ sắm đồ trong ngày đầu đất nước giành độc lập."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
...
<div class="pb-20">
<next-image
		src="/kccm/kccm_12_sai_gon_9.jpg"
		width="400"
		height="250"
		alt="Khí thế Nam Bộ kháng chiến"
		data-tooltip="Người dân đổ ra đường ăn mừng Sài Gòn được giải phóng, đất nước thống nhất ngày 30/4/1975. Ảnh: Jacques Pavlovsky/Sygma/Corbis."
		class="rounded-lg shadow-lg mx-auto"
	/>
</div>
		`,
