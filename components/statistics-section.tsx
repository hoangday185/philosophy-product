	...
	return (
		<section>
			<div className="relative flex h-[30rem] w-full items-center justify-center bg-white dark:bg-black">
				...
				<div className="relative z-20 bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text py-8 text-3xl text-black dark:text-white">
					<div className="flex justify-center">
						<TypewriterEffectSmooth
							words={[{ text: "Thống" }, { text: "kê" }]}
							className="text-2xl md:text-4xl font-bold text-black dark:text-white text-center mb-4"
						/>
					</div>
					...
					<div className="grid md:grid-cols-3 text-md gap-8 text-lg">
						<StatCard
							icon={BookOpen}
							value="5"
